...
final class TimeZoneEpochTest extends TestCase
{
    ...
    public function test_stored_epoch_round_trips_losslessly(string $local, float $offset, string $tzName): void
    {
    ...
    public function test_stored_epoch_is_true_utc_instant(): void
    {
    ...
    public function test_garbage_returns_false(): void
    {
        $this->assertFalse(to_utc_epoch('not-a-date', -5.000));
    }

    public function test_same_local_time_across_offsets_is_different_instant(): void
    {
    ...
    public function test_utc_offset_zero_defaults_to_london(): void
    {
