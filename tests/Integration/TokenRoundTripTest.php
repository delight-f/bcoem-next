...
.'in Slice B — see spec §9. The production fork pins the working behavior.');
    ...
    public function test_token_containing_plus_is_decoded_by_query_string_parser(): void
    {
    ...
    public function test_encrypt_decrypt_round_trip_without_url(): void
    {
        for ($id = 1; $id <= 50; $id++) {
    ...
    public function test_corrupted_token_yields_false_not_numeric_id(): void
    {
