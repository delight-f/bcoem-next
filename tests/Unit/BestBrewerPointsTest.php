...
final class BestBrewerPointsTest extends MySqlTestCase
{
    ...
    private function writeTestConfig(): void
    {
        ...
        if (file_exists($config)) {
            ...
            $this->backupConfig = (string) file_get_contents($config);
        }
...
PHP);
    ...
    public function test_coa_method_single_first_place(): void
    {
    ...
    public function test_coa_method_all_entries_win(): void
    {
    ...
    public function test_coa_method_third_place_from_ten(): void
    {
    ...
    public function test_coa_method_last_place_is_zero(): void
    {
