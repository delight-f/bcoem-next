...
final class TimestampMigrationTest extends TestCase
{
    ...
    public function test_stored_epochs_pass_through_unchanged(string $wallTime, float $offset, string $expectedUtcWall): void
    {
     ...
     */
    public function test_unchanged_when_server_tz_matches_admin_tz(): void
    {
        $previous = date_default_timezone_get();
     ...
     */
    public function test_winner_delay_sentinel_untouched(): void
    {
     ...
     */
    public function test_invalid_and_empty_values_pass_through(): void
    {
