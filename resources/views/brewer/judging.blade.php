<x-public-layout
    ...
    :show-hero="false"
>
    <section id="edit-judging" class="landing-page-section mt-4 mb-3">
        ...
        <form method="post" action="{{ url('/list/edit-judging') }}">
            ...
            @if ($canEditJudge)
                <section id="judge-preferences" class="mb-4">
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            @foreach (array_slice($ranks, 12) as $i => $designation)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="brewerJudgeRank[]"
                    ...
                    @if ($styles->isNotEmpty())
                        <fieldset class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="small text-danger"><strong>{{ __('site.likes_note') }}</strong></p>
                                    @foreach ($styles as $style)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="brewerJudgeLikes[]"
                                ...
                                <div class="col-sm-6">
                                    <p class="small text-danger"><strong>{{ __('site.dislikes_note') }}</strong></p>
                                    @foreach ($styles as $style)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="brewerJudgeDislikes[]"
            ...
            @if ($canEditSteward)
                <section id="steward-preferences" class="mb-4">
                    <div class="mb-3 row">
            ...
            <section id="staff-preferences" class="mb-4">
                <div class="mb-3 row">
            ...
            <section id="judge-steward-waiver" class="mb-4">
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label"><strong>{{ __('site.waiver') }}</strong></label>
                    <div class="col-sm-9">
                        <p>{{ __('site.waiver_voluntary_text') }}</p>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="brewerJudgeWaiver" value="Y"
            ...
            <section id="organizer-notes" class="mb-4">
                <div class="mb-3 row">
