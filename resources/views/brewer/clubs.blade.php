<x-public-layout
    ...
    :show-hero="false"
>
    <section id="edit-clubs" class="landing-page-section mt-4 mb-3">
        ...
        <form method="post" action="{{ url('/list/edit-clubs') }}">
            ...
            <section id="participant-clubs" class="mb-4">
                <div class="mb-3 row">
            ...
            <section id="aha-number" class="mb-4">
                <div class="mb-3 row">
            ...
            @if ($mhpDisplay)
                <section id="mhp-number" class="mb-4">
                    <div class="mb-3 row">
