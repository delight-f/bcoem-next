...
<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="container mt-6 mb-4">
        ...
        <form method="post" action="{{ $isEdit ? route('admin.specialbest.update', ['id' => $category->id]) : route('admin.specialbest.store') }}">
            ...
            <div class="mb-4 row">
                <label for="sbi_name" class="col-sm-3 col-form-label">Name</label>
                <div class="col-sm-6">
                    <input class="input input-bordered" id="sbi_name" name="sbi_name" type="text" required
            ...
            <div class="mb-4 row">
                <label for="sbi_places" class="col-sm-3 col-form-label">Places</label>
                <div class="col-sm-6">
                    <input class="input input-bordered" id="sbi_places" name="sbi_places" type="number" min="1" step="1" required
            ...
            <div class="mb-4 row">
                <label for="sbi_description" class="col-sm-3 col-form-label">Description</label>
                <div class="col-sm-6">
                    <textarea class="textarea textarea-bordered" id="sbi_description" name="sbi_description" rows="6">{{ old('sbi_description', $category->sbi_description ?? '') }}</textarea>
                </div>
            </div>

            <div class="mb-4 row">
                <label for="sbi_rank" class="col-sm-3 col-form-label">Rank</label>
                <div class="col-sm-6">
                    <select class="select select-bordered" id="sbi_rank" name="sbi_rank">
