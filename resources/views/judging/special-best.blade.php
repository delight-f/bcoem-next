        ...
        <div class="bcoem-admin-element hidden-print mb-3">
            ...
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu">
                    @if ($entriesCount > 0)
                        <li><a class="dropdown-item" href="{{ route('admin.specialbest.data.index') }}">All Custom Category Entries</a></li>
                    @else
                        <li><span class="dropdown-item disabled text-muted">All Custom Category Entries</span></li>
                    @endif
                </ul>
            </div>
