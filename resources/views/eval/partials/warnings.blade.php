...
<p id="judging-ends-p" class="fs-6 text-muted">
    <strong>Judging closes:</strong> <span id="judging-ends">{{ \App\Support\Tenant\DateFmt::dateTime((int) ($ctx->judgingStr('jPrefsJudgingClosed') ?? 0), $ctx->prefsStr('prefsTimeZone'), $ctx->prefsStr('prefsDateFormat'), $ctx->prefsStr('prefsTimeFormat'), 'long', $ctx->showTimezone()) }}</span>
</p>
<script>
    (function () {
