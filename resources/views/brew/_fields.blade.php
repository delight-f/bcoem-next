...
<div class="mb-3 row">
    ...
    <div class="col-sm-9">
        <input class="form-control" id="brewName" name="brewName" type="text" required
...
<div class="mb-3 row">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" rows="6" name="brewInfo"
    ...
    <fieldset class="mb-3">
        ...
        @foreach (['Low Carbonation' => 'site.low', 'Medium Carbonation' => 'site.medium', 'High Carbonation' => 'site.high'] as $value => $key)
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="brewMead1" value="{{ $value }}" id="mead1_{{ $loop->index }}"
...
@if ($variantFlags !== null && (int) $variantFlags->brewStyleSweet === 1)
    <fieldset class="mb-3">
        ...
        @foreach (['Low/None Sweetness' => 'site.low', 'Medium Sweetness' => 'site.medium', 'High Sweetness' => 'site.high'] as $value => $key)
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="brewMead2-mead" value="{{ $value }}"
...
<div class="mb-3 row">
    ...
    <div class="col-sm-9">
        <textarea class="form-control" rows="4" name="brewComments"
