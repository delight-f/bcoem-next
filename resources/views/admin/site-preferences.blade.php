...
<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="landing-page-section mt-4 mb-3">
        ...
        @if ($go === 'default')
            <form method="post" action="{{ url('/admin/site-preferences/default') }}" class="form-horizontal">
                @csrf
                @method('put')
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Pro Edition</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Show Homebrew Club Points Page</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Display Winners</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label for="prefsWinnerDelay" class="col-sm-3 col-form-label">Winners Display Date/Time</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsWinnerDelay" name="prefsWinnerDelay" type="text" style="width:auto;" value="{{ \App\Support\Tenant\DateFmt::dateTime($ctx->prefsStr('prefsWinnerDelay'), $tz, $df, $tf, 'system', false) }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsWinnerMethod" class="col-sm-3 col-form-label">Winners Display Method</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsTheme" class="col-sm-3 col-form-label">Theme</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Use Custom Modules?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label for="prefsDropOff" class="col-sm-3 col-form-label">Entry Drop-Off</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsShipping" class="col-sm-3 col-form-label">Shipping</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsLanguage" class="col-sm-3 col-form-label">Language</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsLanguage" name="prefsLanguage" type="text" style="width:auto;" value="{{ $p('prefsLanguage') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsDateFormat" class="col-sm-3 col-form-label">Date Format</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsTimeFormat" class="col-sm-3 col-form-label">Time Format</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsTimeZone" class="col-sm-3 col-form-label">Time Zone (UTC offset)</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsTimeZone" name="prefsTimeZone" type="text" style="width:auto;" value="{{ $p('prefsTimeZone') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Sponsors</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
        ...
        @elseif ($go === 'entries')
            <form method="post" action="{{ url('/admin/site-preferences/entries') }}" class="form-horizontal">
                @csrf
                @method('put')
                <h3>Fees (stored on contest info)</h3>
                @php $c = fn (string $k) => (string) ($ctx->contestStr($k) ?? ''); @endphp
                <div class="mb-3 row">
                    <label for="contestEntryFee" class="col-sm-3 col-form-label">Entry Fee</label>
                    <div class="col-sm-9"><input class="form-control" id="contestEntryFee" name="contestEntryFee" type="text" style="width:auto;" value="{{ $c('contestEntryFee') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="contestEntryFee2" class="col-sm-3 col-form-label">Discounted Entry Fee</label>
                    <div class="col-sm-9"><input class="form-control" id="contestEntryFee2" name="contestEntryFee2" type="text" style="width:auto;" value="{{ $c('contestEntryFee2') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="contestEntryFeeDiscountNum" class="col-sm-3 col-form-label">Discount Threshold (entries)</label>
                    <div class="col-sm-9"><input class="form-control" id="contestEntryFeeDiscountNum" name="contestEntryFeeDiscountNum" type="number" min="1" style="width:auto;" value="{{ $c('contestEntryFeeDiscountNum') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="contestEntryCap" class="col-sm-3 col-form-label">Competition Entry Cap</label>
                    <div class="col-sm-9"><input class="form-control" id="contestEntryCap" name="contestEntryCap" type="number" min="1" style="width:auto;" value="{{ $c('contestEntryCap') }}"></div>
                </div>

                <h3>Limits</h3>
                <div class="mb-3 row">
                    <label for="prefsStyleSet" class="col-sm-3 col-form-label">Style Set</label>
                    <div class="col-sm-9">
                ...
                @foreach ([
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9"><input class="form-control" id="{{ $field }}" name="{{ $field }}" type="number" min="1" style="width:auto;" value="{{ $p($field) }}"></div>
                    </div>
                @endforeach

                <h3>Per-style limits</h3>
                <div class="mb-3 row">
                    <label for="choose-style-entry-limits" class="col-sm-3 col-form-label">Method</label>
                    <div class="col-sm-9">
        ...
        @elseif ($go === 'email')
            <form method="post" action="{{ url('/admin/site-preferences/email') }}" class="form-horizontal">
                @csrf
                @method('put')
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Use SMTP Email?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label for="prefsEmailHost" class="col-sm-3 col-form-label">Host</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsEmailHost" name="prefsEmailHost" type="text" value="{{ $p('prefsEmailHost') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsEmailPort" class="col-sm-3 col-form-label">Port</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsEmailPort" name="prefsEmailPort" type="number" style="width:auto;" value="{{ $p('prefsEmailPort') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsEmailEncrypt" class="col-sm-3 col-form-label">Encryption</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                    <label for="prefsEmailUsername" class="col-sm-3 col-form-label">Username</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsEmailUsername" name="prefsEmailUsername" type="text" value="{{ $p('prefsEmailUsername') }}"></div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <label for="prefsEmailPassword" class="col-sm-3 col-form-label">SMTP Password</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsEmailPassword" name="prefsEmailPassword" type="password" autocomplete="new-password"></div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsEmailFrom" class="col-sm-3 col-form-label">From Address</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsEmailFrom" name="prefsEmailFrom" type="text" value="{{ $p('prefsEmailFrom') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Contact Form</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsContact" value="Y" id="contactY" @checked($p('prefsContact') === 'Y')><label class="form-check-label" for="contactY">Enabled</label></div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsContact" value="N" id="contactN" @checked($p('prefsContact') !== 'Y')><label class="form-check-label" for="contactN">Disabled</label></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Registration Confirmation Emails</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">CC Admin on Emails</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
        ...
        @elseif ($go === 'payment')
            <form method="post" action="{{ url('/admin/site-preferences/payment') }}" class="form-horizontal">
                @csrf
                @method('put')
                @foreach ([
                    ...
                    <div class="mb-3 row">
                        <label for="{{ $field }}" class="col-sm-3 col-form-label">{{ $label }}</label>
                        <div class="col-sm-9"><input class="form-control" id="{{ $field }}" name="{{ $field }}" type="{{ $type }}" style="width:auto;" value="{{ $p($field) }}"></div>
                    </div>
                @endforeach
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Pay to Print?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Accept Cash?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Accept Checks?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label for="prefsCheckPayee" class="col-sm-3 col-form-label">Checks Payable To</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsCheckPayee" name="prefsCheckPayee" type="text" value="{{ $p('prefsCheckPayee') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Accept PayPal?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                <div class="mb-3 row">
                    <label for="prefsPaypalAccount" class="col-sm-3 col-form-label">PayPal Account</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsPaypalAccount" name="prefsPaypalAccount" type="text" value="{{ $p('prefsPaypalAccount') }}"></div>
                </div>
                <button type="submit" class="btn btn-primary">Save Payment Preferences</button>
            </form>
        @else
            <form method="post" action="{{ url('/admin/site-preferences/best') }}" class="form-horizontal">
                @csrf
                @method('put')
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Show Best Brewer?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsShowBestBrewer" value="1" id="bbYes" @checked($p('prefsShowBestBrewer') === '1')><label class="form-check-label" for="bbYes">Yes</label></div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsShowBestBrewer" value="0" id="bbNo" @checked($p('prefsShowBestBrewer') !== '1')><label class="form-check-label" for="bbNo">No</label></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsBestBrewerTitle" class="col-sm-3 col-form-label">Best Brewer Title</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsBestBrewerTitle" name="prefsBestBrewerTitle" type="text" value="{{ $p('prefsBestBrewerTitle') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Show Best Club?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsShowBestClub" value="1" id="bcYes" @checked($p('prefsShowBestClub') === '1')><label class="form-check-label" for="bcYes">Yes</label></div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prefsShowBestClub" value="0" id="bcNo" @checked($p('prefsShowBestClub') !== '1')><label class="form-check-label" for="bcNo">No</label></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="prefsBestClubTitle" class="col-sm-3 col-form-label">Best Club Title</label>
                    <div class="col-sm-9"><input class="form-control" id="prefsBestClubTitle" name="prefsBestClubTitle" type="text" value="{{ $p('prefsBestClubTitle') }}"></div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Use BOS in Best Brewer/Club Scoring?</label>
                    <div class="col-sm-9">
                        <div class="form-check form-check-inline">
                ...
                @foreach ([
                    ...
                    <div class="mb-3 row">
                        <label for="{{ $field }}" class="col-sm-3 col-form-label">{{ $label }}</label>
                        <div class="col-sm-9"><input class="form-control" id="{{ $field }}" name="{{ $field }}" type="number" min="0" style="width:auto;" value="{{ $p($field) }}"></div>
                    </div>
                @endforeach
