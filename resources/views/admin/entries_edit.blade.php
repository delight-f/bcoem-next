<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="container mt-4 mb-3">
        ...
        <form method="post" action="{{ route('backoffice.entries.update', ['id' => $entry->id]) }}">
            ...
            <div class="mb-3 row">
                <label for="brewName" class="col-sm-3 col-form-label"><strong>Entry Name *</strong></label>
                <div class="col-sm-9">
            ...
            <div class="mb-3 row">
                <label for="brewStyle" class="col-sm-3 col-form-label"><strong>Style *</strong></label>
                <div class="col-sm-9">
            ...
            <div class="mb-3 row">
                <label for="brewBoxNum" class="col-sm-3 col-form-label">Loc/Box</label>
                <div class="col-sm-9">
            ...
            <div class="mb-3 row">
                <label for="brewAdminNotes" class="col-sm-3 col-form-label">Admin Notes</label>
                <div class="col-sm-9">
            ...
            <div class="mb-3 row">
                <label for="brewStaffNotes" class="col-sm-3 col-form-label">Staff Notes</label>
                <div class="col-sm-9">
