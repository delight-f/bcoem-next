<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="container mt-6 mb-4">
        ...
        <form method="post" action="{{ route('backoffice.participants.update', ['uid' => $participant->uid]) }}">
            ...
            <div class="mb-4 row">
                <label for="brewerFirstName" class="col-md-4 col-form-label"><strong>First Name *</strong></label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerFirstName" name="brewerFirstName" required
                           value="{{ old('brewerFirstName', $participant->brewerFirstName) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerLastName" class="col-md-4 col-form-label"><strong>Last Name *</strong></label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerLastName" name="brewerLastName" required
                           value="{{ old('brewerLastName', $participant->brewerLastName) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerEmail" class="col-md-4 col-form-label"><strong>Email *</strong></label>
                <div class="col-md-9">
            ...
            <div class="mb-4 row">
                <label for="brewerPhone1" class="col-md-4 col-form-label">Phone</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerPhone1" name="brewerPhone1"
                           value="{{ old('brewerPhone1', $participant->brewerPhone1) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerAddress" class="col-md-4 col-form-label">Address</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerAddress" name="brewerAddress"
                           value="{{ old('brewerAddress', $participant->brewerAddress) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerCity" class="col-md-4 col-form-label">City</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerCity" name="brewerCity"
                           value="{{ old('brewerCity', $participant->brewerCity) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerState" class="col-md-4 col-form-label">State/Region</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerState" name="brewerState"
                           value="{{ old('brewerState', $participant->brewerState) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerZip" class="col-md-4 col-form-label">Postal Code</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerZip" name="brewerZip"
                           value="{{ old('brewerZip', $participant->brewerZip) }}">
                </div>
            </div>

            <div class="mb-4 row">
                <label for="brewerClubs" class="col-md-4 col-form-label">Club(s)</label>
                <div class="col-md-9">
                    <input class="form-control" id="brewerClubs" name="brewerClubs"
            ...
            <hr>
            <div class="mb-4 row">
                <label class="col-md-4 col-form-label"><strong>Change Security Question/Answer?</strong></label>
                <div class="col-md-9">
                    ...
                    <div class="form-text">Do you wish to change your security question and/or answer?</div>
                </div>
            </div>

            <div id="security-question-change">
                <div class="mb-4 row">
                    <label for="security" class="col-md-4 col-form-label">Security Question</label>
                    <div class="col-md-9">
                        <select class="form-select" id="security" name="userQuestion">
                ...
                <div class="mb-4 row">
                    <label for="userQuestionAnswer" class="col-md-4 col-form-label">Security Answer</label>
                    <div class="col-md-9">
                        <input class="form-control" id="userQuestionAnswer" name="userQuestionAnswer" type="text"
            ...
            <div class="mb-4 row">
                <label for="password" class="col-md-4 col-form-label">Reset Password</label>
                <div class="col-md-9">
