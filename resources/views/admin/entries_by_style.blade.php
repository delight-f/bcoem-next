<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="container mt-6 mb-4">
        ...
        @if ($filter === 'no_zeros')
            <a class="btn btn-outline-secondary mb-4" href="{{ url('/backoffice/count-by-style') }}">Show Categories with Zero Entries</a>
        @else
            <a class="btn btn-outline-secondary mb-4" href="{{ url('/backoffice/count-by-style?filter=no_zeros') }}">Hide Categories with Zero Entries</a>
        @endif
