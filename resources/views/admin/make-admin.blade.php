<x-public-layout :ctx="$ctx" :show-hero="false">
    <section class="landing-page-section mt-4 mb-3">
        ...
        <form method="post" action="{{ url('/admin/users/'.$user->id.'/level') }}">
            ...
            <fieldset>
                <legend class="small">User Level for {{ $user->user_name }}</legend>
                ...
                <div class="form-check mt-2">
                    ...
                    <span class="help-block d-block">If you wish to hide judging numbers from this Admin user, check the box.</span>
                </div>
            </fieldset>

            <button type="submit" class="btn btn-primary mt-3">Change User Level</button>
        </form>
    </section>
</x-public-layout>
